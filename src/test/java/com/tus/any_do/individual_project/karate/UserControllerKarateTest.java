...
@Sql(
	scripts = {
		"classpath:test_data/karate_sql_files/user_controller/users.sql"
	},
	executionPhase = ExecutionPhase.BEFORE_TEST_METHOD
)
@Sql(
    scripts = {
    	"classpath:test_data/karate_sql_files/user_controller/cleanup.sql"
    },
...
public class UserControllerKarateTest {
	...
	Karate runAll() {
		return Karate.run(
			FOLDER + "/get_teamworkers.feature"
		).relativeTo(getClass());
	}
